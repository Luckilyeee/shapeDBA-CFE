...
def parse_arguments(standalone=False):
    ...
    parser.add_argument('--single_sample_id', type=int, help='Single Sample',default=97)
    ...
    parser.add_argument('--dataset', type=str, default='Coffee',
                        ...
                        choices=["GunPoint", "Coffee", "ECG200", "TwoLeadECG",  "CBF", "Plane", "BirdChicken",
                                 "1", "2", "3", "4", "5", "6", "7"])
    ...
    parser.add_argument('--l_budget_coeff', type=float, help='L Budget Coefficient', default=1.0)  # 0.05
    parser.add_argument('--l_tv_norm_coeff', type=float, help='L TV Norm Coefficient', default=1.0)
    parser.add_argument('--tv_beta', type=float, help='TV Norm Beta', default=3)
    parser.add_argument('--l_max_coeff', type=float, help='L max Coefficient', default=1.0)
    # parser.add_argument('--l_l1_coeff', type=float, help='L1 loss Coefficient', default=1.0)
    parser.add_argument('--l_spar_coeff', type=float, help='L sparsity Coefficient', default=1.0)
